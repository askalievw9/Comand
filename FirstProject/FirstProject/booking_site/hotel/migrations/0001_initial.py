    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(110)])),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region='KG')),
                ('user_status', models.CharField(choices=[('simple', 'simple'), ('owner', 'owner')], default='simple', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservation_status', models.CharField(choices=[('свободен', 'свободен'), ('забронирован', 'забронирован'), ('занят', 'занят')], default='свободен', max_length=16)),
                ('room_price', models.PositiveIntegerField()),
                ('room_description', models.TextField()),
                ('rooms', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rooms', to='hotel.hotel')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
